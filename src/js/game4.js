...
Room.Game4.ini = function(){
    ...
    cvtw.get(cav_game4.img["game4_plant1_1"], {loop:true}).to({rotation:1 }, 1510).to({rotation:0 }, 1550);
    cvtw.get(cav_game4.img["game4_plant1_3"], {loop:true}).to({rotation:-0.3 }, 1010).to({rotation:0 }, 1050).to({rotation:0.3 }, 1030).to({rotation:0 }, 1070);
    cvtw.get(cav_game4.img["game4_plant1_4"], {loop:true}).to({rotation:-1.2 }, 1300).to({rotation:0 }, 1390).to({rotation:1.2 }, 1310).to({rotation:0 }, 1320);
